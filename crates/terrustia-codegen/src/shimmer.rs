...
//!
//! Not wired into [`crate::main`]'s `TABLES` yet: verified byte-identical against the committed
//! table except for one paragraph of its module doc, which a past hand-edit (commit `78d07de`)
//! updated in the `.rs` without updating this generator's own docstring to match. See the
//! Codegen entry in `TODO.md` for the exact diff and what fixing it needs.
