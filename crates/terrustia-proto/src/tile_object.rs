...
//! anchored at its top, and placing either at the wrong origin puts furniture through the floor.
//!
...
impl TileObject {
    ...
    /// rows at a time and a table's run across it.
...
mod tests {
    ...
    /// A handful of objects everyone knows the shape of. If these are right the transcription
