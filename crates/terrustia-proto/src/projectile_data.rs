...
pub struct ProjectileStats {
    ...
    /// Ticks it lives for.
    ///
    /// The game's own default is 3600 — a full minute — and only the few types that state
    /// otherwise get less. Most projectiles hit something long before that; the ones that pass
    /// through terrain are the reason it matters.
    pub time_left: i32,
