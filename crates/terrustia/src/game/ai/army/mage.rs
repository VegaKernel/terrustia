...
use terrustia_proto::npc_params::{
    ARMY_FADE_IN, DARK_MAGE_BOLT, DARK_MAGE_BOLT_AT, DARK_MAGE_BOLT_DAMAGE, DARK_MAGE_BOLT_RANGE,
    DARK_MAGE_BOLT_SPEED, DARK_MAGE_CASTS, DARK_MAGE_COOLDOWN, DARK_MAGE_HEAL, DARK_MAGE_HEAL_AT,
    DARK_MAGE_HEAL_OUT, DARK_MAGE_PORTAL, DARK_MAGE_RAISE_AT, DARK_MAGE_SHORT_COOLDOWN,
};
