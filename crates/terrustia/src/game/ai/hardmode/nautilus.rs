...
use terrustia_proto::npc_params::{
    ...
    NAUTILUS_SPRAY_COUNT, NAUTILUS_SPRAY_DAMAGE, NAUTILUS_SPRAY_RECOIL, NAUTILUS_SPRAY_SHOT,
    NAUTILUS_SPRAY_SPEED, NAUTILUS_SPRAY_SPREAD, NAUTILUS_SPRAY_TICKS, NAUTILUS_SPRAY_WINDUP,
    NAUTILUS_STANDOFF, NAUTILUS_SUMMON_AT, NAUTILUS_SUMMON_TICKS,
};
