...
use terrustia_proto::npc_params::{
    EMPRESS_ARRIVAL, EMPRESS_BLAST, EMPRESS_DAMAGE, EMPRESS_DAMAGE_PHASE_2, EMPRESS_DASH_OUT,
    EMPRESS_DASH_SPEED, EMPRESS_ETHEREAL_LANCE, EMPRESS_FLY_ACCEL, EMPRESS_FLY_SPEED,
